...
std::shared_ptr<MinHashSketch> MinHashSketchVector::Intersect(
    const std::vector<std::shared_ptr<MinHashSketch>>& sketches, size_t max_sample_count) {
    auto result = ComputeIntersection(sketches, validity.get(), max_sample_count);
    ShrinkToFit();
    return result;
}

std::shared_ptr<MinHashSketch> MinHashSketchVector::Combine(
...
std::shared_ptr<MinHashSketch> MinHashSketchVector::ComputeIntersection(
    const std::vector<std::shared_ptr<MinHashSketch>>& sketches, ValidityMask* mask, size_t max_sample_size) {
