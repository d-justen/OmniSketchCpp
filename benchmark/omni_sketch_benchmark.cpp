...
constexpr size_t BYTES_PER_SAMPLE = sizeof(uint64_t) * WIDTH * DEPTH;
constexpr size_t BYTES_PER_MB = 1048576;
constexpr size_t SAMPLE_COUNT = 64;
constexpr size_t ATTRIBUTE_VALUE_COUNT = 50000;
...
(::benchmark::State& state) {
    const auto sample_count = static_cast<size_t>(state.range());
